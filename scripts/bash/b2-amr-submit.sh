#!/bin/bash
#SBATCH --job-name=Rans2-AMR
#SBATCH -A open
#SBATCH -N 1
#SBATCH -n 8
#SBATCH --mem-per-cpu=32G
#SBATCH -t 48:00:00
#SBATCH -o Rans2-AMR.out
#SBATCH -e Rans2-AMR.err
#SBATCH --export=ALL
#SBATCH --mail-type=END
#SBATCH --mail-user sjc6663@psu.edu


#write job start time to log file Rans2-AMR.out
echo "Job started at $(date)"

#set variables
READS=/storage/group/evk5387/default/stephanie/ransom-amr++/bovine-host/b2
OUT=/storage/home/sjc6663/scratch/ransom-out/b2
...
export NXF_WORK=/storage/home/sjc6663/scratch/nf-work-rans/b2
...
#write job end time to log file Rans2-AMR.out
